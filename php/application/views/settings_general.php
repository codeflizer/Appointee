...
<div data-role="page" id="settings">
	<div data-theme="a" data-role="header">
		<h3>Settings</h3>
		<a data-role="button" data-transition="fade" href="../Main/main_tab/"
	...
	<div data-role="content" style="padding: 15px">
		<ul data-role="listview" data-divider-theme="d" data-inset="false">
			...
			<li data-theme="c"><a href="personal_menu/" data-ajax="false">
					<h3>Personal Settings</h3>
					<p>Change your first and last name</p>
			</a></li>
			<li data-theme="c"><a href="email_menu/" data-ajax="false">
					<h3>E-Mail Settings</h3>
					<p>Change your e-mail address.</p>
			</a></li>
			<li data-theme="c"><a href="password_menu/" data-ajax="false">
					<h3>Password Settings</h3>
					<p>Change your password.</p>
			</a></li>
			<li data-theme="c"><a href="logout/" data-ajax="false">
					<h3>Logout</h3>
					<p></p>
			</a></li>
		</ul>
