...
<div data-role="page" id="home">
	...
	<div data-role="content" style="padding: 15px">
		<a data-role="button" data-transition="fade" href="<?=base_url()?>new_appointment/start"  data-ajax="false" data-icon="appintee-plus">
	  ...
	  <li data-theme="c"><a href="<?=base_url() ?>main/appointment_details/" data-transition="slide"  data-ajax="false">
	...
	<div data-role="footer" data-position="fixed">
		<div data-role="navbar" data-iconpos="top" data-theme="c">
			<ul>
				<li><a href="<?=base_url() ?>main/main_tab/" data-theme="" data-icon="appointee-home" data-ajax="false"
					class="ui-btn-active ui-state-persist">Home</a></li>
				<li><a href="<?=base_url() ?>main/history_tab/" data-theme="" data-icon="appointee-history" data-ajax="false"
					>History</a></li>
				<li><a href="<?=base_url() ?>main/contacts_tab/" data-theme="" data-icon="appointee-contacts" data-ajax="false"
					>Contacts</a></li>
			</ul>
		</div>
	</div>
